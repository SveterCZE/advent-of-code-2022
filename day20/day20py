...
def part1(instructions):
    for i in range(instructions.get_circular_list_length()):
        ...
        if currently_moved_node.get_node_value() > 0:
            currently_moved_node.move_node_right(currently_moved_node.get_node_value())
        elif currently_moved_node.get_node_value() < 0:
            currently_moved_node.move_node_left(currently_moved_node.get_node_value())
        else:
            pass
        # checked_value = instructions.first_inserted_item
        # new_list = []
        # for j in range(instructions.get_circular_list_length()):
        #     new_list.append(checked_value.get_node_value())
        #     checked_value = checked_value.next_value
        # print(i,new_list)
...
class CircularNode:
    ...
    def move_node_right(self, move_count):
        # TODO --- modulo
    ...
    def move_node_left(self, move_count):
        for i in range(abs(move_count)):
